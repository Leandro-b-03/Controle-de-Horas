...
@section('scripts')
    ...
    <script>
      ...
      function initMap() {
        var map = new google.maps.Map(document.getElementById('map'), {
          zoom: 15,
          center: {lat: -23.497, lng: -46.8479835}
        });

        setMarkers(map);
      }

      var users = {!! json_encode($data['locations']) !!};
    ...
    <!-- Google Maps -->
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAMjB9eA7xTNXxROIy_4IS4HbuijRQ84YA&signed_in=true&callback=initMap" async defer></script>
@endsection