            ...
            @endif
              <div class="box-body">
                ...
                <div class="form-group col-xs-4">
                  ...
                  <select name="user" class="form-control" data-validation="required" data-validation-error-msg="{!! Lang::get('projects.error-manager') !!}" required>
                ...
                <div class="form-group col-xs-4">
                  ...
                  <select name="clients" class="form-control" data-validation="required" data-validation-error-msg="{!! Lang::get('projects.error-clients') !!}" required>
                    <option value="">{!! Lang::get('general.select') !!}</option>
